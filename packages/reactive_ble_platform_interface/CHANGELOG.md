...
* Bump version for 5.5.0+7 release (implementation updates in `reactive_ble_mobile` and `flutter_reactive_ble`)

## 5.5.0+6

* Bump version for 5.5.0+6 release (implementation updates in `reactive_ble_mobile` and `flutter_reactive_ble`)
...
* Add `WriteCharacteristicFailure.timedOut`
