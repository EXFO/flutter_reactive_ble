...
open class ReactiveBleClient(private val context: Context) : BleClient {
    ...
    private fun getConnection(
        ...
        if (device.connectionState == RxBleConnection.RxBleConnectionState.CONNECTED) {
            ...
            // See Pull request : https://github.com/PhilipsHue/flutter_reactive_ble/pull/928/changes#diff-59244a996f05c5cf1d74a385db95dd9e74d709e4f51366e7beae678bbf121dabR287
